...
async function startDownloadJob(params, prefix) {
  ...
  try {
    ...
    if (!startRes.ok || !startData.jobId) {
      throw new Error(
        startData.error || `Could not start download (${startRes.status})`,
      );
    }
...
const legalContent = {
  terms: {
    ...
    html: `
      <p>
        Welcome to VidSnatch. By using this website, you agree to
        use the service responsibly and in accordance with applicable
        laws and the terms of the platforms from which content is accessed.
      </p>

      <h3>Use of the Service</h3>
      <p>
        VidSnatch provides an online interface for processing publicly
        accessible media URLs. You are responsible for ensuring that
        you have the necessary rights or permission to download or save
        any content you process through the service.
      </p>

      <h3>Prohibited Use</h3>
      <p>
        You must not use VidSnatch for unlawful activities, copyright
        infringement, unauthorized distribution, or abuse of the service.
      </p>

      <h3>Service Availability</h3>
      <p>
        VidSnatch is provided on an availability basis. Features may be
        modified, suspended, or discontinued when necessary.
      </p>

      <h3>User Responsibility</h3>
      <p>
        Users are responsible for the content they download and how
        they use it after downloading.
      </p>
    `,
  },
  ...
  privacy: {
    ...
    html: `
      <p>
        Your privacy is important to us. VidSnatch is designed to provide
        a simple media downloading service while minimizing unnecessary
        collection of personal information.
      </p>

      <h3>Information We Process</h3>
      <p>
        When you submit a media URL, the URL is processed by our server
        to retrieve the requested media information and, when requested,
        prepare the download.
      </p>

      <h3>Temporary Download Files</h3>
      <p>
        Download files may be temporarily stored on the server while
        a download job is being processed. Temporary files are removed
        after the download job expires.
      </p>

      <h3>Cookies</h3>
      <p>
        VidSnatch does not require users to create an account.
        Hosting infrastructure or third-party services may use
        necessary cookies or similar technologies according to
        their own policies.
      </p>

      <h3>Personal Information</h3>
      <p>
        Do not submit passwords, private account information, or other
        sensitive information through VidSnatch.
      </p>
    `,
  },
  ...
  copyright: {
    ...
    html: `
      <p>
        VidSnatch respects copyright and intellectual property rights.
      </p>

      <h3>User Responsibility</h3>
      <p>
        Only download content that you own, have permission to use,
        or are legally permitted to download. You are responsible
      ...
      <p>
        VidSnatch does not claim ownership of content submitted or
        processed through the service.
      </p>

      <h3>Copyright Concerns</h3>
      <p>
        If you believe that content or functionality associated with
        VidSnatch infringes your rights, please contact us with
        sufficient information so the matter can be reviewed.
      </p>
    `,
  },
  ...
  contact: {
    ...
    html: `
      <p>
        If you have a question, report, copyright concern, or
        technical issue, you can contact the VidSnatch team.
      </p>
      ...
      <p>
        Please include enough information about your issue so that
        we can understand and respond to your request.
      </p>
    `,
  },
};
